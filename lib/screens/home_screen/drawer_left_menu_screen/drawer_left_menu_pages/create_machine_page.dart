...
class CreateMachinePage extends StatefulWidget {
  @override
  CreateMachinePageState createState() => CreateMachinePageState();
}

class CreateMachinePageState extends State<CreateMachinePage>
    with AfterLayoutMixin<CreateMachinePage> {
  ...
  List<DropdownMenuItem<MachineCategolaryModel>>
      _dropDownMenuItems_Machine_Cato;
        ...
        if (va != null) {
          if (this.mounted) {
            setState(() {
              ...
              _dropDownMenuItems_Machine_Cato =
                  getDropDownMenuItems_Machine_Cate();
            });
          }
        }
      });
  ...
  List<DropdownMenuItem<CellModel>> getDropDownMenuItems_Cell(
      List<CellModel> lst) {
                  ...
                  Padding(
                      ...
                      child: ButtonTheme(
                          ...
                          child: DropdownButton(
                            ...
                            style: StylesText.style13Black,
                            isExpanded: true,
                            hint: Text(allTranslations.text("choose_cell"),
                                style: StylesText.style13Blugray),
                      ...
                      child: Align(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                allTranslations.text("machine_position_hint"),
  ...
  Future onNewMachine() async {
    if (_currentItem_Line == null) {
      ...
      Navigator.of(context).pop();
      return Toast.show(allTranslations.text("not_choose_cell_yet"), context,
          duration: Toast.LENGTH_SHORT, gravity: Toast.BOTTOM);
    } else if (_currentItem_Machine_Cata == null) {
      Navigator.of(context).pop();
      return Toast.show(allTranslations.text("not_choose_machine_cato_yet"), context,
          duration: Toast.LENGTH_SHORT, gravity: Toast.BOTTOM);
    } else {
