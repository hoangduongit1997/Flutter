...
Future<List<LineModel>> GetLinesHasMachineRepository() async {
  try {
    ...
    Response response = await post(
        Configs.isDebugMode
            ? "http://testlotus.pikatech.vn:5010/getlineshasMachine"
            : "http://lotus.pikatech.vn:5010/getlineshasMachine",
        body: final_body,
    ...
    print(e.toString());
    FlutterCrashlytics().log(e.toString(), priority: 200, tag: 'Error in get line has machine res');
    return null;
  }
}
