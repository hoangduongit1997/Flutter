...
Future<int> DeleteMachineCategolaryRepository(String name, int id_cato) async {
  try {
    ...
    Response response = await post(
        Configs.isDebugMode
            ? "http://testlotus.pikatech.vn:5010/removemachinecategorys"
            : "http://lotus.pikatech.vn:5020/removemachinecategorys",
        body: final_body,
