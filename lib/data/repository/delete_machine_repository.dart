...
Future<int> DeleteMachineRepository(int id_machine, int mcateId, int cell_Id, String name) async {
  try {
    ...
    Response response = await post(
        Configs.isDebugMode
            ? "http://testlotus.pikatech.vn:5010/removemachines"
            : "http://lotus.pikatech.vn:5020/removemachines",
        body: final_body,
    ...
    print(e.toString());
    FlutterCrashlytics().log(e.toString(), priority: 200, tag: 'Error in delete machine res');
